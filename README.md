# Backend em Node - Portal Adm e App
...
PGPASSWORD="PASSWORD@2024" pg_dump -U portaldbett -h 192.168.0.26 -p 5432 portaldbett > /home/dev/workspace/db-ett-portal/$(date +%Y%m%d-%H%M%S)-portaldbett.sql
